                                        ...
                                        <AccordionContent className="pl-8">
                                            <div className="space-y-2">
                                                {subSubject.chapters.map((chapter) => {
                                                    ...
                                                    const hasAttempted = attemptedQuizzes.includes(chapter.id);
                                                    return (
                                                        <div key={chapter.id} className="flex items-center justify-between p-3 rounded-md bg-muted/50">
                                                            ...
                                                            <Button size="sm" variant={hasAttempted ? 'outline' : 'default'} onClick={() => handleSelectChapter(chapter.mcqs!, chapter.id, chapter.name)}>
